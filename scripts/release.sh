#!/bin/bash
#
# Test Pulp 2 Tests for sanity. If all is well, generate a new commit, tag it,
...
# Sanity check Pulp 2 Tests packages on Python 3
...
for dist in dist/*; do
    ...
    pip uninstall --quiet --yes pulp_2_tests
done
set +u
deactivate
set -u
